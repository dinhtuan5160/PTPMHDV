                                    ...
                                    <div class="news-item-text">
                                        ...
                                        <div class="news-avatar">
                                            ...
                                            <span class="d-inline-block mt-1">
                                                <a href="">{{$congvantimkiem->User->name}}</a>
                                            </span>
                                            <span> - </span>
                                            
                                            <span> {{$congvantimkiem->created_at}}</span>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="news-name">
                                            <a href="viewer/congvanden/chitiet/{{$congvantimkiem->id}}">
                                                <h4>{{$congvantimkiem->name}}</h4>
                                            </a>
                                        </div>
                                        <div class="news-info">
                                            <p>Dung lượng
                                                <span class="macv"> {{number_format($congvantimkiem->storage/1048576,2)}}KB </span>
                                            </p>
                                            <p>Loại công văn:
                                                <span class="pdf">
                                                    <?php
                                                    $arr = explode(".",$congvantimkiem->file);
                                                    ?>
                                        ...
                                        <div class="text-center mt-4">
                                            <a href="viewer/congvanden/chitiet/{{$congvantimkiem->id}}" class="chitiet">Xem chi tiết</a>
                                            <a href="download/{{$congvantimkiem->file}}" download="{{$congvantimkiem->file}}">
